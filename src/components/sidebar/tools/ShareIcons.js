...
const ShareIcons = ({ handleAdd, panningPosition }) => {
    const handleClick = () => {
        ...
        const twitter = new fabric.Path('M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564\
        ...
        const linkedIn = new fabric.Path('M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11\
        ...
        const instagram = new fabric.Path('M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919\
        ...
        const youtube = new fabric.Path('M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385\
